"""
Django settings for goalstats_api project.
...
SECRET_KEY = 'django-insecure-_txpq!8&u%d$dgwww1bvmzc*&#5a)jqg5_+)eq#rm$lyvpxx5m'
...
WSGI_APPLICATION = 'goalstats_api.wsgi.application'
